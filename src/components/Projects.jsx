...
class Projects extends React.Component {
  state = {
    cards: [
      ...
      {
        link: "https://weather.tristanvaramashvili.dev/",
        class: "card-image --weather",
        text: "Weather App: Technologies used: Node.js, express, Javascript, CSS, Ejs, Weather API",
      },
      {
        link: "https://maritours.netlify.app/",
        class: "card-image --shop",
        text: "Travel Agency Website, Technologies used: Html, css, Javascript, React, Netlify Serverless Functions",
      },
      {
